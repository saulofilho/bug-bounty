...
export const DocsAndChecklistsView: React.FC<DocsAndChecklistsViewProps> = ({
  ...
  const handleInsertPayloadIntoDoc = (payload: ExploitPayload) => {
    const payloadSnippet = `\n\n### Payload: ${payload.title} [${payload.category}]\n\`\`\`\n${payload.payload}\n\`\`\`\n**Contexto:** ${payload.context || 'Geral'}\n${payload.description ? `**Descrição:** ${payload.description}\n` : ''}`;
    
    if (selectedDoc) {
      setEditTitle(selectedDoc.title);
      setEditCategory(selectedDoc.category);
      setEditContent(isEditing ? editContent + payloadSnippet : selectedDoc.content + payloadSnippet);
        ...
        <>
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs uppercase tracking-wider transition-all shadow-sm active:scale-95 shrink-0"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div className="lg:col-span-4 rounded-2xl bg-[#0a0a0a] border border-[#262626] p-4 space-y-4">
                      ...
                      {doc.isChecklist && totalItems > 0 && (
                        <div className="pt-1 space-y-1">
                          <div className="flex items-center justify-between text-[10px] text-zinc-400 font-mono">
                            ...
                            <span>
                              {completedCount}/{totalItems} ({Math.round((completedCount / totalItems) * 100)}%)
                            </span>
                          </div>
            ...
            <div className="lg:col-span-8 rounded-2xl bg-[#0a0a0a] border border-[#262626] p-6 space-y-6">
              {isEditing ? (
                /* Editing Form */
                <div className="space-y-4 text-xs">
                  <div className="flex items-center justify-between pb-3 border-b border-[#262626]">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg bg-[#171717] hover:bg-[#262626] text-zinc-300 font-semibold border border-[#262626] uppercase tracking-wider"
                      >
                        Cancelar
                      </button>
                      <button
                        onClick={handleSaveEdit}
                        className="flex items-center gap-1.5 px-4 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white font-bold uppercase tracking-wider"
                      >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="w-full bg-[#121212] border border-[#262626] rounded-lg p-2.5 text-zinc-200 text-xs focus:border-emerald-500 focus:outline-none"
                      />
                    </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full bg-[#121212] border border-[#262626] rounded-lg p-2.5 text-zinc-200 text-xs focus:border-emerald-500 focus:outline-none font-mono"
                    />
                  </div>
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center justify-between">
                      ...
                      >
                        ...
                        <span>Abrir Biblioteca de Payloads</span>
                      </button>
                    </div>
                    <textarea
                      rows={14}
                      ...
                      className="w-full bg-[#121212] border border-[#262626] rounded-lg p-3 text-zinc-200 font-mono text-xs focus:border-emerald-500 focus:outline-none leading-relaxed"
                    />
                  </div>
                </div>
              ) : selectedDoc ? (
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 pb-4 border-b border-[#262626]">
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap gap-1.5 font-mono">
                        {selectedDoc.tags.map((t) => (
                          <span
                            key={t}
                            className="px-2 py-0.5 rounded bg-[#121212] text-zinc-400 text-xs border border-[#262626]"
                          >
                            #{t}
                          </span>
                        ))}
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      <button
                        ...
                        className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-[#171717] hover:bg-[#262626] border border-[#262626] text-zinc-300 text-xs font-medium uppercase tracking-wider transition-all"
                      >
                  ...
                  {selectedDoc.isChecklist && selectedDoc.checklistItems && (
                    <div className="space-y-3 p-4 rounded-xl bg-[#121212] border border-[#262626]">
                  ...
                  <div className="p-5 rounded-xl bg-[#121212] border border-[#262626] text-xs text-zinc-300 font-mono leading-relaxed whitespace-pre-wrap">
                    {selectedDoc.content}
                  </div>
                </div>
              ) : (
